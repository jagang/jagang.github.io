library platelist.web.main.generated_metadata;
...
import 'package:di/annotations.dart' as import_3;
...
final Map<Type, Object> typeAnnotations = {
  import_0.PlateListComponent: const [
    const import_1.Component(selector: 'platelist', templateUrl: 'packages/platelist/platelist.html', cssUrl: 'packages/platelist/platelist.css', map: const {'limit': '=>limit', 'bottom': '=>bottom'}),
  ],
  import_2.Animate: const [
    const import_3.Injectable(),
  ],
  import_2.BrowserCookies: const [
    const import_3.Injectable(),
  ],
  import_2.Cookies: const [
    const import_3.Injectable(),
  ],
  import_2.Compiler: const [
    const import_3.Injectable(),
  ],
  import_2.CompilerConfig: const [
    const import_3.Injectable(),
  ],
  import_2.DirectiveMap: const [
    const import_3.Injectable(),
  ],
  import_2.ElementBinderFactory: const [
    const import_3.Injectable(),
  ],
  import_2.EventHandler: const [
    const import_3.Injectable(),
  ],
  import_2.ShadowRootEventHandler: const [
    const import_3.Injectable(),
  ],
  import_2.DefaultShadowBoundary: const [
    const import_3.Injectable(),
  ],
  import_2.ShadowRootBoundary: const [
    const import_3.Injectable(),
  ],
  ...
  import_2.NgElement: const [
    const import_3.Injectable(),
  ],
  import_2.DirectiveSelectorFactory: const [
    const import_3.Injectable(),
  ],
  import_2.ShadowDomComponentFactory: const [
    const import_3.Injectable(),
  ],
  import_2.ComponentCssRewriter: const [
    const import_3.Injectable(),
  ],
  import_2.TranscludingComponentFactory: const [
    const import_3.Injectable(),
  ],
  import_2.Content: const [
    const import_1.Decorator(selector: 'content', map: const {'select': '@select'}),
  ],
  import_2.NullTreeSanitizer: const [
    const import_3.Injectable(),
  ],
  import_2.ViewFactoryCache: const [
    const import_3.Injectable(),
  ],
  import_2.PlatformJsBasedShim: const [
    const import_3.Injectable(),
  ],
  import_2.DefaultPlatformShim: const [
    const import_3.Injectable(),
  ],
  ...
  import_4.InputDateLike: const [
    const import_1.Decorator(selector: 'input[type=date][ng-model]', module: import_4.InputDateLike.moduleFactory),
    const import_1.Decorator(selector: 'input[type=time][ng-model]', module: import_4.InputDateLike.moduleFactory),
    const import_1.Decorator(selector: 'input[type=datetime][ng-model]', module: import_4.InputDateLike.moduleFactory),
    const import_1.Decorator(selector: 'input[type=datetime-local][ng-model]', module: import_4.InputDateLike.moduleFactory),
    const import_1.Decorator(selector: 'input[type=month][ng-model]', module: import_4.InputDateLike.moduleFactory),
    const import_1.Decorator(selector: 'input[type=week][ng-model]', module: import_4.InputDateLike.moduleFactory),
  ],
  ...
  import_4.InputRadio: const [
    const import_1.Decorator(selector: 'input[type=radio][ng-model]', module: import_4.NgValue.module),
  ],
  ...
  import_4.NgSwitch: const [
    const import_1.Decorator(selector: '[ng-switch]', map: const {'ng-switch': '=>value', 'change': '&onChange'}, visibility: import_1.Visibility.DIRECT_CHILD),
  ],
  ...
  import_4.OptionValue: const [
    const import_1.Decorator(selector: 'option', module: import_4.NgValue.module),
  ],
  import_4.NgForm: const [
    const import_1.Decorator(selector: 'form', module: import_4.NgForm.module, map: const {'name': '&name'}),
    const import_1.Decorator(selector: 'fieldset', module: import_4.NgForm.module, map: const {'name': '&name'}),
    const import_1.Decorator(selector: '.ng-form', module: import_4.NgForm.module, map: const {'name': '&name'}),
    const import_1.Decorator(selector: '[ng-form]', module: import_4.NgForm.module, map: const {'ng-form': '&name', 'name': '&name'}),
  ],
  ...
  import_15.NgView: const [
    const import_1.Decorator(selector: 'ng-view', module: import_15.NgView.module, visibility: import_1.Visibility.CHILDREN),
  ],
  import_15.NgBindRoute: const [
    const import_1.Decorator(selector: '[ng-bind-route]', module: import_15.NgBindRoute.module, map: const {'ng-bind-route': '@routeName'}),
  ],
